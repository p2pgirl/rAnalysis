...
#changing harvest year data to char
coffeedata$Harvest.Year.Begin <- as.character(coffeedata$Harvest.Year.Begin)

#changing harvest year data to single year
...
This makes me realize that processing makes an impact on flavor of coffee more than I initially thought.  However how is one to really know what processing is used?  So, that's where origins and patterns come in to play.  The top five "total cup point on average" countries tend to be:  1. United States 2. Papua New Guinea, 3. Ethiopia, 4. Japan and 5. Kenya.  It's easy to say that United States has the best coffee, but there is a enough evidence to show it may actually be Ethiopia.
...
Also, it is a matter of taste and opinion. For example those that process with the Natural/Dry method will have more of a fruity taste. If you don't like fruity coffee, then one will not prefer coffees processed that way. 
